...
$config['site']['realurl'] = "http://underfoxserver.tk/"; // Put the real url for your website without www DO NOT FORGET FROM / AT THE END
$config['site']['realurlwww'] = "http://underfoxserver.tk/"; // Put the real url for your website with www IF IT IS A SUBDOMINUM PUT THE MSM URL OF THE REAL URL
...
if ($config['base_url'] == $config['site']['realurl'] || $config['base_url'] == $config['site']['realurlwww']) {
	$config['site']['serverPath'] = "H:/Jogos/Tibia/12x/otx sem erros/OTX/"; // SERVER PATH IN PRODUCTION
} else {
	$config['site']['serverPath'] = "H:/Jogos/Tibia/12x/otx sem erros/OTX/"; // SERVERPATH LOCALHOST
}
/** END SERVER PATHS */
...
$config['site']['widget_Serverinfoboxfloat'] = false;
...
$config['social']['facebook'] = "http://fb.com/ukimianomuro"; // Link to your facebook page
...
$config['site']['quests'] = array(
    ...
    'Inquisition' => 6548,
    'Demon Oak' => 20004,
	'Dragon Scale Legs' => 6671,
	'Master Anihiliation' => 2128,
    'Umbral Quest (Founders)' => 22402,
	'Melhor Arma Vocacao (MAV)' => 2352
);
...
$config['site']['mail_address'] = "andreoam@gmail.com";
...
$config['site']['smtp_pass'] = "ERE!m2admalm";
$config['site']['smtp_secure'] = false;
...
$config['site']['info_bar_cast'] = false;
...
$config['donate']['offers'] = [
	...
	6 => [(70 * 100) => 70],
	7 => [(80 * 100) => 80],
	8 => [(100 * 90) => 100], //10% discount
	9 => [(200 * 80) => 200], //20% discount
	10 => [(300 * 80) => 300], //20% discount
	11 => [(400 * 70) => 400], //30% discount
	// 9 => [24500 => 5000]
];
...
$config['pagseguro']['email'] = "andreoam@gmail.com";
...
// /** PayPal configs */
$config['paypal']['email'] = "andreoam@gmail.com";
$config['paypal']['sandboxemail'] = "sb-tus2k11316539@business.example.com";
...
// /** PRODUCTION IDS */
$config['paypal']['clientID'] = "ATiUxmMkhkX5Ur5NvKQrt_kHltHf3ZE5gSe6Y-RA_-B9Ey8gW4FKKKiPRuLIH6yrU-jnzexLFbdudNFY";
$config['paypal']['clientSecretID'] = "ELSiIzkUOgqu89o-m2_XFR_A4LfPy1HcksD8YTGC_KJpVPyy64zXqZmt27Y5k_Xk_slLGOxP0lMZhJzi";
// /** SANDBOX IDS */
...
$config['mp']['CLIENT_ID'] = "6398866014436092";
$config['mp']['CLIENT_SECRET'] = "SztLhCyw7dW7G2M7uuX488gET93uiB4h";
