...
if (!$logged) {
	...
	if (isset($_POST['step']) && $_POST['step'] == 'docreate') {
		...
		elseif ($password1 != $password2)
			...
			$err = [];
			if (strlen($password1) < 2 || strlen($password1) > 29) {
				$err[] = 'The password must have at least 2 and less than 30 letters!';
			}
															...
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																...
																<tr>
																	<td class="LabelV150" >
																		...
																		<span class="HelperDivIndicator" onMouseOver="ActivateHelperDiv($(this), \'Use o mesmo que em Account\', \'Se voce preferir, pode usar a mesma account como email e isso facilitara seu login no client.\', \'\');" onMouseOut="$(\'#HelperDivContainer\').hide();" >
														...
														<div class="TableContentContainer" >
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																...
																<tr>
																	<td class="LabelV150" >
																		<span id="email_label"' . (isset($e['email']) ? ' class="red"' : '') . '>Email Address:</span>
																		<span class="HelperDivIndicator" onMouseOver="ActivateHelperDiv($(this), \'Use o mesmo que em Account Name!\', \'Se voce preferir, pode usar a mesma account como email e isso facilitara seu login no client.\', \'\');" onMouseOut="$(\'#HelperDivContainer\').hide();" >
																		<image style="border:0px;" src="' . $layout_name . '/images/global/content/info.gif" />
																		</span></span>
																	</td>
																	<td>
